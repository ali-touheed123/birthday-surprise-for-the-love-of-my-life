...
const appCss = "/birthday-surprise-for-the-love-of-my-life/assets/styles-C5D4Xpqj.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "For Noor — A Love Story in Scroll" },
      { name: "description", content: "A love letter five years in the making. Scroll through the moments that built a quiet, unwavering devotion." },
      { name: "author", content: "Ali" },
      { property: "og:title", content: "For Noor — A Love Story in Scroll" },
      { property: "og:description", content: "A love letter five years in the making." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400;1,600&family=DM+Sans:wght@300;400;500;700&display=swap" }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-Dku77STb.js");
